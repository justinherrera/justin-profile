    ...
    <div className="bg-[#191919] h-auto md:h-screen w-[100vw]" id="projects-page" ref={projectsRef}>
      <div className="flex flex-col h-full pt-12">
        ...
        <div className="flex flex-col md:flex-row md:space-x-10 justify-center items-center">
          {[1,2,3].map((element) => (
            <div className="works-div flex flex-row mt-10 cursor-pointer transition duration-700 ease-in-out hover:scale-110">
              <div className="border-1 p-4 border border-white rounded">
                <p className="text-2xl text-white">Customer Feedback App</p>
                <small className="text-white">Tech Used: </small>
                <img src={mj_src} height={300} width={300}/>
